...
class Ui_PlotterToolbar(object):
    def setupUi(self, PlotterToolbar):
        ...
        self.commands_layout.setSizeConstraint(QLayout.SetDefaultConstraint)
        ...
        self.commands_layout.addWidget(self.lbFluorophoreIndex)
        ...
        self.commands_layout.addWidget(self.pbAssignFluorophores)

        self.horizontalSpacer_3 = QSpacerItem(
            60, 20, QSizePolicy.Expanding, QSizePolicy.Minimum
        )

        self.commands_layout.addItem(self.horizontalSpacer_3)

...
class Ui_PlotterToolbar(object):
    def setupUi(self, PlotterToolbar):
        ...
        self.pbOpenAnalyzer.setObjectName(u"pbOpenAnalyzer")
        sizePolicy1 = QSizePolicy(QSizePolicy.MinimumExpanding, QSizePolicy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.pbOpenAnalyzer.sizePolicy().hasHeightForWidth())
        ...
        self.pbOpenInspector.setObjectName(u"pbOpenInspector")
        ...
        sizePolicy1.setHeightForWidth(self.cbFluorophoreIndex.sizePolicy().hasHeightForWidth())
        ...
        self.pbUnmixColors.setObjectName(u"pbUnmixColors")
        self.pbUnmixColors.setEnabled(True)
        sizePolicy1.setHeightForWidth(self.pbUnmixColors.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy1.setHeightForWidth(self.cbFirstParam.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy1.setHeightForWidth(self.cbSecondParam.sizePolicy().hasHeightForWidth())
        ...
        self.cbColorCodeSelector.addItem("")
        self.cbColorCodeSelector.setObjectName(u"cbColorCodeSelector")
    ...
    def retranslateUi(self, PlotterToolbar):
        ...
        self.pbOpenAnalyzer.setText(QCoreApplication.translate("PlotterToolbar", u"Analyze", None))
        self.pbOpenInspector.setText(QCoreApplication.translate("PlotterToolbar", u"Time Inspect", None))
        self.lbFluorophoreIndex.setText(QCoreApplication.translate("PlotterToolbar", u"Fluorophore", None))
        self.cbFluorophoreIndex.setItemText(0, QCoreApplication.translate("PlotterToolbar", u"All", None))

        self.pbUnmixColors.setText(QCoreApplication.translate("PlotterToolbar", u"Unmix", None))
        self.pbPlot.setText(QCoreApplication.translate("PlotterToolbar", u"Plot", None))
        self.cbColorCodeSelector.setItemText(0, QCoreApplication.translate("PlotterToolbar", u"No color code", None))
        self.cbColorCodeSelector.setItemText(1, QCoreApplication.translate("PlotterToolbar", u"Color-code by TID", None))

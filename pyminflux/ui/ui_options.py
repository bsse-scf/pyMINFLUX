...
class Ui_Options(object):
    def setupUi(self, Options):
        ...
        self.gridLayout.addWidget(self.lbInfo, 7, 0, 1, 1)
        ...
        self.gridLayout.addLayout(self.hlWeightAvgLocByECO, 11, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lbInfoImmediate, 9, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pbSetDefault, 17, 0, 1, 1)

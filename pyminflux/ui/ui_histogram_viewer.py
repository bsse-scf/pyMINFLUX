...
class Ui_HistogramViewer(object):
    def setupUi(self, HistogramViewer):
        if not HistogramViewer.objectName():
            HistogramViewer.setObjectName(u"HistogramViewer")
    ...
    def retranslateUi(self, HistogramViewer):
        HistogramViewer.setWindowTitle(QCoreApplication.translate("HistogramViewer", u"Histogram Viewer", None))
        self.cbEnableEFOFiltering.setText(QCoreApplication.translate("HistogramViewer", u"Filter on EFO values", None))
        self.cbEnableCFRFiltering.setText(QCoreApplication.translate("HistogramViewer", u"Filter on CFR values", None))
        self.pbUpdateViewers.setText(QCoreApplication.translate("HistogramViewer", u"Update", None))
        self.pbAutoThreshold.setText(QCoreApplication.translate("HistogramViewer", u"Auto-threshold", None))
    # retranslateUi

...
class Ui_ColorUnmixer(object):
    def setupUi(self, ColorUnmixer):
        ...
        self.twMainTabs.setObjectName("twMainTabs")
        ...
        self.tabDcrUnmixing.setObjectName("tabDcrUnmixing")
        ...
        self.horizontalSpacer_2 = QSpacerItem(
            61, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.horizontalSpacer_5 = QSpacerItem(
            241, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.horizontalSpacer_6 = QSpacerItem(
            240, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.tabTimeSplitting.setObjectName("tabTimeSplitting")
        ...
        self.lbNumSplits.setObjectName("lbNumSplits")
        ...
        self.sbNumSplits.setObjectName("sbNumSplits")
        ...
        self.pbTimeSplitAssign.setObjectName("pbTimeSplitAssign")
        sizePolicy2.setHeightForWidth(
            self.pbTimeSplitAssign.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, ColorUnmixer):
        ColorUnmixer.setWindowTitle(
            QCoreApplication.translate("ColorUnmixer", "Unmixer", None)
        )
        self.lbNumFluorophores.setText(
            QCoreApplication.translate("ColorUnmixer", "Number of channels", None)
        )
        ...
        self.twMainTabs.setTabText(
            self.twMainTabs.indexOf(self.tabDcrUnmixing),
            QCoreApplication.translate("ColorUnmixer", "DCR unmixing", None),
        )
        self.lbNumSplits.setText(
            QCoreApplication.translate("ColorUnmixer", "Number of splits", None)
        )
        self.pbSplit.setText(QCoreApplication.translate("ColorUnmixer", "Show", None))
        self.pbTimeSplitAssign.setText(
            QCoreApplication.translate("ColorUnmixer", "Assign", None)
        )
        self.twMainTabs.setTabText(
            self.twMainTabs.indexOf(self.tabTimeSplitting),
            QCoreApplication.translate("ColorUnmixer", "Time splitting", None),
        )

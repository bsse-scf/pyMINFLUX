...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbProject = QLabel(self.dataviewer_widget)
        ...
        self.lbProject.setMinimumSize(QSize(0, 24))
        font = QFont()
        font.setPointSize(10)
        font.setBold(True)
        self.lbProject.setFont(font)

        self.project_layout.addWidget(self.lbProject)

        self.pbSelectProjectFolder = QPushButton(self.dataviewer_widget)
        self.pbSelectProjectFolder.setObjectName(u"pbSelectProjectFolder")

        self.project_layout.addWidget(self.pbSelectProjectFolder)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbProject.setText(QCoreApplication.translate("MainWindow", u"Project", None))
        self.pbSelectProjectFolder.setText(QCoreApplication.translate("MainWindow", u"Set folder", None))

...
class Ui_Importer(object):
    def setupUi(self, Importer):
        ...
        self.gridLayout.addWidget(self.lbLastValidInfo, 21, 0, 1, 3)
        ...
        self.gridLayout.addItem(self.fixedVerticalSpacer, 23, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.line, 25, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.pb_last_valid, 20, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.lbDwellTime, 28, 0, 1, 1)

        self.verticalSpacer = QSpacerItem(
            20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding
        )

        self.gridLayout.addItem(self.verticalSpacer, 29, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.cbPoolDCR, 27, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.cbTracking, 26, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.leDwellTime, 28, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.lbRelocInfo, 22, 0, 1, 3)
        ...
        self.lbSelectionWarning = QLabel(Importer)
        self.lbSelectionWarning.setObjectName("lbSelectionWarning")
        self.lbSelectionWarning.setFont(font)
        self.lbSelectionWarning.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.gridLayout.addWidget(self.lbSelectionWarning, 18, 0, 1, 3)

        QWidget.setTabOrder(self.pbIter_0, self.pbIter_1)
        QWidget.setTabOrder(self.pbIter_1, self.pbIter_2)
        QWidget.setTabOrder(self.pbIter_2, self.pbIter_3)
        QWidget.setTabOrder(self.pbIter_3, self.pbIter_4)
        QWidget.setTabOrder(self.pbIter_4, self.pbIter_5)
        QWidget.setTabOrder(self.pbIter_5, self.pbIter_6)
        QWidget.setTabOrder(self.pbIter_6, self.pbIter_7)
        QWidget.setTabOrder(self.pbIter_7, self.pbIter_8)
        QWidget.setTabOrder(self.pbIter_8, self.pbIter_9)
        QWidget.setTabOrder(self.pbIter_9, self.pbIter_10)
        QWidget.setTabOrder(self.pbIter_10, self.pbIter_11)
        QWidget.setTabOrder(self.pbIter_11, self.pbIter_12)
        QWidget.setTabOrder(self.pbIter_12, self.pbIter_13)
        QWidget.setTabOrder(self.pbIter_13, self.pbIter_14)
        QWidget.setTabOrder(self.pbIter_14, self.pbIter_15)
        QWidget.setTabOrder(self.pbIter_15, self.pb_last_valid)
        QWidget.setTabOrder(self.pb_last_valid, self.cbTracking)
        QWidget.setTabOrder(self.cbTracking, self.cbPoolDCR)
        QWidget.setTabOrder(self.cbPoolDCR, self.leDwellTime)
    ...
    def retranslateUi(self, Importer):
        ...
        self.lbSelectionWarning.setText(
            QCoreApplication.translate(
                "Importer",
                "Non-relocalized traces have length 1 and will be discarded.",
                None,
            )
        )

...
class MinFluxDataset:
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            full_raw_dataframe=(
                full_raw_dataframe.copy() if full_raw_dataframe is not None else None
            ),
            valid_raw_data_array=(
                valid_raw_data_array.copy()
                if valid_raw_data_array is not None
                else None
            ),
    ...
    def copy(self):
        ...
        return MinFluxDataset(
            ...
            full_raw_dataframe=(
                self._full_raw_dataframe.copy()
                if self._full_raw_dataframe is not None
                else None
            ),
            valid_raw_data_array=(
                self._valid_raw_data_array.copy()
                if self._valid_raw_data_array is not None
                else None
            ),

...
<p align="center">
  <img width="800" src="https://bsse-scf.github.io/pyMINFLUX/img/pyminflux.png">
</p>
...
The latest version of pyMINFLUX can also be installed from [pypi.org](https://pypi.org/project/pyminflux/). pyMINFLUX is compatible with and tested on Python 3.11, 3.12, 3.13, and 3.14. It is recommended to install pyMINFLUX in a conda environment as follows:
...
pyMINFLUX is compatible with and tested on Python 3.11, 3.12, 3.13, and 3.14. For development, you can e.g. install pyMINFLUX in editable mode in a [conda](https://docs.conda.io/en/latest/miniconda.html#latest-miniconda-installer-links) environment as follows:
